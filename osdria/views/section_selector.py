...
class SectionSelector(QLabel):
    ...
    def loadLogos(self):
        self.image = {
            "Overview": QPixmap(":/icons/icons/logo_light@2x.png"),
            "Energy": QPixmap(":/icons/icons/logo_light_energy@2x.png"),
            "Water": QPixmap(":/icons/icons/logo_light_water@2x.png"),
            "Food": QPixmap(":/icons/icons/logo_light_food@2x.png"),
            "Business": QPixmap(":/icons/icons/logo_light_business@2x.png")
        }
